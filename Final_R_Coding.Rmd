...
Covid-19 is a worldwide pandemic that needs no introduction. It influenced the lives of us all and it's impact is still being felt to this day. At the start of the pandemic, the WHO began collecting data on Covid-19 patients across the globe. Covid- 19 data from Jan 1, 2020 and Dec 31, 2022 was retrieved from the World Health Organization. Case fatality rate, prevalence and mortality rate in each country where documentation was shared are reported below. 
...
Socioeconomic (SE) factors were found to be associated with diagnosis and prognosis of Covid-19 patients across the globe. The pandemic highlighted gaps not only in healthcare systems, but social and economic systems. In this dashboard, gross domestic product, average income, and unemployment rate were considered against case fatality rate in Covid-19 patients. 
